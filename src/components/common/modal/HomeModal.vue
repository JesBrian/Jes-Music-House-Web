<template>
  <div v-if="this.$store.state.modalType !== ''" style="width:100%; height:100%; top:0; left:0; position:fixed; background:rgba(0, 0, 0, 0.5); z-index:9999;">

    <!-- 各种拟态框组件 -->
    <component :is="this.$store.state.modalType" style="z-index:5">
      <!-- 关闭按钮 -->
