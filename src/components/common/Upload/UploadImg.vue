...
import mimes from '../../../assets/js/mimes.js'
import data2blob from '../../../assets/js/data2blob.js'
import effectRipple from '../../../assets/js/effectRipple.js'
...
export default {
  ...
  data () {
    ...
    let lang = language[langType] ? language[langType] : language['en']
