<template>
  <div id="homeLayout">
    ...
    <div style="width:88%; height:38px; margin:0 auto 10px; padding-top:18px; box-shadow:0 5px 8px -5px #00d8ff; text-align:center; border-bottom:1px solid #00d8ff; line-height:27px; font-weight:700;">
