<template>
  <div id="homeLayout">
    ...
    <div class="box-show" style="height:328px; padding:2px 68px 0; position:relative;">
      <!-- 轮播图区域 -->
      ...
      <div style="width:27.5%; height:100%; float:right;">
        ...
        <div style="width:100%; height:138px; border-bottom:2px solid #222; position:relative;">
          ...
          <div class="super-btn-out ripple" style="width:70px; height:28px; top:42px; left:86px; position:absolute;">
            <span class="super-btn-in mh-if sign-in" style="width:61px; height:20px; font-size:15px;">&nbsp;签到</span>
          </div>
